...
K=3
MODEL_PATH="jhgan/ko-sroberta-multitask"  # embedding model path (DPR) 
...
# EMBEDDING_PATH="../dpr_embeddings/embedding.ko-sroberta-multitask.512.pt"

# dpr
python ../src/run_retrieval.py hybrid --search_target_path $SEARCH_TARGET_PATH \
