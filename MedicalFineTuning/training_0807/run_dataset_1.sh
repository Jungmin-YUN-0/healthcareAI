...
# 시스템 프롬프트 설정 리스트
USE_SYSTEM_PROMPT_OPTIONS=("True")
# "True"

# 공통 경로 설정
CHECKPOINT_PATH="/home/project/rapa/checkpoint_dataset_1"
CACHE_PATH="/home/project/rapa/cache"
BASE_SAVE_PATH="/home/project/rapa/final_model_dataset_1"
DATA_PATH="/home/project/rapa/dataset/genmed_dataset"
    ...
    for USE_QLORA in "${USE_QLORA_OPTIONS[@]}"; do
        for USE_SYSTEM_PROMPT in "${USE_SYSTEM_PROMPT_OPTIONS[@]}"; do
            for NUM_EPOCHS in "${EPOCH_LIST[@]}"; do
                ...
                CUDA_VISIBLE_DEVICES=2,3 deepspeed train_dataset_1.py \
                    --job "$JOB_TYPE" \
